...
import {Address, AddressForm, AddressShipping} from "../adress";
...
export class AddressFormComponent  implements ControlValueAccessor, MatFormFieldControl<Address>, OnDestroy {
    static nextId = 0;
  @ViewChild('company')
